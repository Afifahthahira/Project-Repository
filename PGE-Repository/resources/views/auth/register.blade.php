...
<head>
    ...
    <title>Register | PEMA Global Energi Docs</title>
    ...
    <style>
        * {
        ...
        body {
            background: linear-gradient(to bottom right, #f4f7ff, #eaf3ff);
            height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="register-container">
        ...
        @if ($errors->any())
            <div style="background: #fee2e2; color: #991b1b; padding: 10px; border-radius: 6px; margin-bottom: 1rem;">
